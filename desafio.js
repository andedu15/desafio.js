...
var resultado = {
    ...
    ganador: contadorPuntosJug1 > contadorPuntosJug2 ? jugadorUno.nombre : contadorPuntosJug2 > contadorPuntosJug1 ? jugadorDos.nombre : jugadorUno.nombre + " y " + jugadorDos.nombre + " empate",
}
